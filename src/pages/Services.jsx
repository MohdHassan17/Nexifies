...
function Services({ serviceImg, serviceName, serviceText }) {
  ...
  return (
    <>
      <Helmet>
        <title>{serviceName} | Nexifies</title>
        <meta
          name="description"
          content={`Discover how Nexifies provides top-notch ${serviceName} tailored for businesses to thrive in the digital era.`}
        />
        <meta
          name="keywords"
          content={`Nexifies ${serviceName}, ${serviceName} solutions, software development`}
        />
        <link
          rel="canonical"
          href={`https://www.nexifies.com/services/`}
        />
      </Helmet>
      ...
      <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 class=" sm:text-4xl text-3xl mb-4 heading-1 ">
              {serviceName}{" "}
            </h1>
            <div class="mb-6 leading-relaxed">
              <div className="landing-about-us">
                <div className="landing-about-text mb-3">
                  <p className="para-text text-justify">{serviceText}</p>
                </div>
              </div>
            </div>
            <div class="flex justify-center">
              <a href="/testimonials">
                <button class="btn primary-btn">Read Testimonials</button>
              </a>
              <a href="/contact-us">
                {" "}
